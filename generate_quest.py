...
AUTHENTIC_ROOMS = {
    "forest1": [2, 4, 5, 7, 8, 10, 11, 16],
    "forest2": [1, 2, 3, 4, 5, 6, 10, 11, 12, 13, 15],
    "cave1": [10, 11, 12, 20, 30, 31, 32, 33, 34, 40, 50, 51, 52, 53, 60],
    "cave2": [10, 11, 12, 13, 14, 15, 16, 20, 21, 22, 23, 30, 35, 40, 45, 60],
    "cave3": [20, 21, 22, 23, 30, 31, 32, 33, 40, 41, 50, 51, 52, 53, 54, 61, 70, 71],
    "mine1": [20, 21, 30, 40, 41, 50, 51, 52, 53, 54, 60, 61, 75, 90],
    "mine2": [20, 21, 30, 40, 41, 50, 51, 52, 53, 60, 61, 70, 80, 90],
    "ruins1": [10, 11, 12, 20, 21, 22, 23, 24, 30, 31, 32, 33, 40, 50, 55, 60, 61, 70],
    "ruins2": [20, 21, 23, 24, 30, 31, 32, 33, 34, 40, 41, 42, 43, 44, 50, 60, 65, 70, 75, 80],
    "ruins3": [20, 21, 22, 23, 30, 31, 32, 33, 40, 41, 42, 43, 44, 50, 55, 60, 65, 80],
    "temple_alpha": [10, 11, 20, 30, 40, 41, 50, 60, 61, 70, 91, 92, 93, 94],
    "temple_beta": [10, 11, 20, 30, 40, 41, 50, 60, 61, 70, 91, 93],
    "space_alpha": [10, 11, 20, 21, 30, 31, 32, 40, 41, 42, 50, 51, 52],
    "space_beta": [10, 11, 12, 20, 21, 31, 32, 33, 40, 41, 42, 50, 51, 52, 182],
    "jungle_north": [1, 3, 4, 6, 7, 8, 11, 12, 15],
    "seabed_upper": [20, 21, 30, 60, 61, 62, 63, 64, 70, 71, 80, 81, 90, 213, 221, 260, 280, 281],
    "seabed_lower": [20, 30, 50, 51, 52, 53, 70, 71, 80, 81, 90, 95, 211, 214, 280, 290, 291],
    "crater_east": [10, 11, 20, 21, 22, 30, 40, 41, 50, 60, 80, 90],
    "desert1": [20, 30, 41, 50, 60, 61, 62, 63, 64, 70, 90, 100, 110],
    "desert2": [10, 20, 21, 22, 23, 24, 25, 27, 40, 41, 42, 50],
    "desert3": [20, 21, 40, 41, 42, 50, 51, 60, 61, 70, 80, 100, 101, 110],
}

def get_area_key(wireframe_id, area_name):
    w = (wireframe_id or '').lower()
    a = (area_name or '').lower()
    if 'forest01' in w or 'forest 1' in a: return 'forest1'
    if 'forest02' in w or 'forest 2' in a: return 'forest2'
    if 'cave01' in w or 'cave 1' in a or 'caves 1' in a: return 'cave1'
    if 'cave02' in w or 'cave 2' in a or 'caves 2' in a: return 'cave2'
    if 'cave03' in w or 'cave 3' in a or 'caves 3' in a: return 'cave3'
    if 'machine01' in w or 'mine 1' in a or 'mines 1' in a: return 'mine1'
    if 'machine02' in w or 'mine 2' in a or 'mines 2' in a: return 'mine2'
    if 'ancient01' in w or 'ruins 1' in a: return 'ruins1'
    if 'ancient02' in w or 'ruins 2' in a: return 'ruins2'
    if 'ancient03' in w or 'ruins 3' in a: return 'ruins3'
    if 'ruins01' in w or 'temple alpha' in a: return 'temple_alpha'
    if 'ruins02' in w or 'temple beta' in a: return 'temple_beta'
    if 'space01' in w or 'spaceship alpha' in a: return 'space_alpha'
    if 'space02' in w or 'spaceship beta' in a: return 'space_beta'
    if 'jungle' in w or 'jungle' in a: return 'jungle_north'
    if 'seabed01' in w or 'seabed upper' in a: return 'seabed_upper'
    if 'seabed02' in w or 'seabed lower' in a: return 'seabed_lower'
    if 'wilds' in w or 'crater' in a: return 'crater_east'
    if 'desert01' in w or 'desert 1' in a: return 'desert1'
    if 'desert02' in w or 'desert 2' in a: return 'desert2'
    if 'desert03' in w or 'desert 3' in a: return 'desert3'
    return 'forest1'

AUTHENTIC_ROOM_OFFSETS = {
    "forest1": { 2: [-138.6, 14.1, 6.2], 4: [1.5, 6.2, -12.6], 5: [-40.0, 14.3, 51.6], 7: [-14.9, 1.7, -15.3], 8: [54.6, 31.5, 31.0], 10: [79.8, 28.1, -39.1], 11: [74.1, 22.0, 136.1], 16: [-20.5, 11.0, 56.4] },
    "forest2": { 1: [53.3, 57.5, 24.6], 2: [-2.2, 29.9, 170.5], 3: [-8.1, 12.0, 137.2], 4: [-9.0, 52.3, 109.9], 5: [-80.4, 41.3, 67.0], 6: [-222.1, 37.3, -3.1], 10: [-42.0, 22.6, -32.0], 11: [-234.7, 18.1, 137.3], 12: [-35.2, 54.7, -100.3], 13: [-10.8, 23.3, -147.3], 15: [96.3, 20.4, -0.7] },
    "cave1": { 10: [0.7, 0.0, 6.4], 11: [1.7, 0.0, -3.9], 12: [-11.9, 0.0, -2.5], 20: [9.8, 0.0, 7.2], 30: [-6.1, 2.4, -16.3], 31: [-16.1, 2.5, 22.0], 32: [13.2, 1.4, 40.6], 33: [9.8, 2.3, 8.8], 34: [1.9, 2.5, 18.1], 40: [18.6, 2.2, 5.7], 50: [4.2, -5.8, -24.6], 51: [3.1, -4.8, -8.8], 52: [3.1, -5.4, -4.4], 53: [-7.3, -6.1, 20.2], 60: [-1.8, 0.0, -11.6] },
    "cave2": { 10: [6.2, -0.1, 6.1], 11: [-3.6, -0.5, 16.0], 12: [5.9, -0.6, 45.3], 13: [-10.8, -0.1, 5.7], 14: [5.4, -0.4, 3.4], 15: [10.5, -0.4, 13.8], 16: [14.7, -0.8, 18.4], 20: [4.7, -0.5, 29.0], 21: [-1.9, -0.3, -27.6], 22: [-6.1, -0.5, 3.7], 23: [12.4, -0.4, 21.4], 30: [12.7, -0.1, -0.6], 35: [-10.1, -0.0, -0.4], 40: [-34.3, -0.1, -16.7], 45: [-14.6, -0.1, -56.3], 60: [6.4, -0.0, -4.0] },
    "cave3": { 20: [-12.7, 0.8, 1.2], 21: [-13.2, 0.5, 3.7], 22: [-14.0, 1.4, 12.2], 23: [-7.3, 0.6, -15.8], 30: [-7.4, -0.0, 16.4], 31: [-0.9, -0.0, -29.2], 32: [-5.1, -0.0, -14.0], 33: [-19.6, -0.0, -24.5], 40: [-5.2, 0.0, 5.5], 41: [-30.3, 0.0, -48.7], 50: [16.2, 0.0, -6.6], 51: [43.4, 0.0, -0.3], 52: [-2.3, 0.0, 17.7], 53: [30.0, 0.0, 1.9], 54: [-16.1, 0.0, 2.0], 61: [2.3, 0.0, -5.1], 70: [3.9, -0.7, 23.3], 71: [3.5, -0.6, 48.5] },
    "mine1": { 20: [-4.7, 11.8, -4.1], 21: [-1.0, 13.9, -0.1], 30: [-0.4, 21.2, -0.3], 40: [7.1, 0.0, 4.2], 41: [-0.2, 30.9, -43.3], 50: [7.3, 3.3, 7.0], 51: [-0.7, 0.0, 18.0], 52: [1.4, 1.2, 17.3], 53: [-0.4, 4.2, -6.0], 54: [0.0, 0.0, -12.5], 60: [1.3, 5.0, 7.1], 61: [-1.5, 1.9, 0.4], 75: [11.1, 8.1, -22.9], 90: [32.6, -0.0, -4.4] },
    "mine2": { 20: [-21.3, 44.5, -1.8], 21: [8.9, 69.3, -5.2], 30: [-1.4, 10.7, 1.3], 40: [-2.7, 72.9, 3.7], 41: [-0.9, 54.6, -4.4], 50: [-18.9, 3.3, 7.0], 51: [-6.4, 10.4, -3.1], 52: [-1.9, 20.2, -10.5], 53: [-7.8, 14.2, 0.3], 60: [2.2, 7.3, 8.0], 61: [7.5, 2.9, 1.8], 70: [23.6, 11.8, -18.5], 80: [-8.1, 6.5, 10.6], 90: [-83.7, 6.2, 1.8] },
    "ruins1": { 10: [0.7, 0.0, 7.0], 11: [-6.8, 0.0, -8.0], 12: [0.7, 0.0, 10.2], 20: [-0.9, 0.0, 2.2], 21: [-5.5, 0.0, -7.6], 22: [0.3, 0.0, -2.4], 23: [3.7, 0.0, -4.3], 24: [-10.0, 0.0, -7.7], 30: [20.7, 0.0, -5.4], 31: [-5.3, 0.0, -14.7], 32: [1.5, 0.0, 5.7], 33: [-8.7, 0.0, -5.8], 40: [41.6, 4.0, 51.2], 50: [16.7, -3.0, 7.2], 55: [21.1, -0.2, 11.0], 60: [-2.1, 2.0, 8.2], 61: [1.1, 2.9, -20.0], 70: [-98.5, 0.0, -209.8] },
    "ruins2": { 20: [-0.0, 0.0, -44.0], 21: [2.7, 41.8, -0.8], 23: [-1.8, 21.5, 7.1], 24: [7.3, 29.8, 1.5], 30: [-1.8, 12.4, 7.4], 31: [7.8, 0.0, 12.8], 32: [-12.9, 25.0, 8.0], 33: [16.4, 13.7, 7.4], 34: [-7.7, 15.7, 13.0], 40: [5.8, 11.1, 1.2], 41: [-10.3, 30.5, 5.8], 42: [5.7, 23.3, 9.7], 43: [4.1, 17.5, 2.0], 44: [4.1, 14.3, -13.2], 50: [18.2, 4.6, 41.5], 60: [9.1, 6.0, -6.8], 65: [24.5, -2.4, 60.4], 70: [-45.6, 0.9, 39.8], 75: [8.9, 2.8, 29.4], 80: [0.1, 27.3, 32.6] },
    "ruins3": { 20: [-0.2, 0.0, 6.9], 21: [1.0, 0.0, -9.1], 22: [-0.4, 0.0, 0.4], 23: [-0.1, 0.0, 6.3], 30: [4.1, 0.0, 15.6], 31: [9.1, -0.0, 9.9], 32: [-1.2, -0.0, 1.6], 33: [0.1, -0.0, -2.9], 40: [0.8, 0.0, -7.6], 41: [20.6, 0.0, -13.0], 42: [19.7, 0.0, 2.1], 43: [-2.8, 0.0, 21.7], 44: [22.0, 0.0, -23.2], 50: [37.4, 3.2, 22.2], 55: [-19.4, 6.7, -25.0], 60: [-12.1, -2.0, 6.6], 65: [1.7, 2.9, -12.9], 80: [10.8, 2.5, -32.8] },
    "temple_alpha": { 10: [7.7, 0.0, 12.2], 11: [-9.2, 0.0, 3.4], 20: [2.9, 0.0, -0.6], 30: [3.8, 0.0, -11.6], 40: [4.6, -0.0, -1.4], 41: [0.6, -0.0, -4.9], 50: [0.3, 0.0, 30.6], 60: [-6.2, -0.0, 81.0], 61: [-0.2, -0.0, 76.9], 70: [10.0, 0.0, 4.9], 91: [24.1, 0.0, -6.4], 92: [25.6, 0.0, -11.0], 93: [0.3, 0.0, -5.6], 94: [5.7, -0.0, 7.0] },
    "temple_beta": { 10: [4.8, 0.0, 7.6], 11: [0.8, -0.0, -4.3], 20: [-4.6, -0.0, -6.2], 30: [-5.1, 0.1, -2.8], 40: [1.2, -0.0, 0.6], 41: [4.0, 0.0, 4.0], 50: [1.1, 0.0, 13.1], 60: [1.9, 0.0, 93.5], 61: [-4.8, 0.6, 81.6], 70: [11.8, 0.0, 2.9], 91: [-7.4, -0.0, -8.1], 93: [-5.9, -0.0, 4.4] },
    "space_alpha": { 10: [1.7, -1.2, 39.4], 11: [1.6, -0.4, -4.0], 20: [-0.3, -1.3, -2.0], 21: [-1.4, -0.2, 3.1], 30: [-0.1, -0.6, -18.3], 31: [2.3, -0.5, -32.4], 32: [0.8, -0.8, -21.1], 40: [0.9, 0.0, -2.2], 41: [2.6, 0.0, -3.3], 42: [-0.8, 0.0, -14.6], 50: [1.9, 0.0, 17.5], 51: [-2.0, 0.0, -17.9], 52: [1.6, 0.0, -15.2] },
    "space_beta": { 10: [-5.4, -0.7, 0.8], 11: [-7.0, 0.0, -0.1], 12: [9.2, -1.0, 4.7], 20: [4.8, -0.7, -7.4], 21: [-1.2, -1.0, -2.8], 31: [-2.1, -1.3, -22.5], 32: [10.1, -1.6, -40.8], 33: [-4.4, -1.0, -22.9], 40: [0.5, 0.0, -17.8], 41: [1.5, 0.0, 1.6], 42: [2.3, 0.0, 6.0], 50: [-1.7, 0.0, -15.4], 51: [-0.9, 0.0, -17.3], 52: [0.9, 0.0, 14.3], 182: [0.2, 32.7, -38.3] },
    "jungle_north": { 1: [51.1, 32.0, 72.7], 3: [-29.3, 2.7, -25.4], 4: [-19.9, 9.3, 17.7], 6: [24.8, 0.0, 79.3], 7: [3.3, 21.3, -2.5], 8: [23.0, 12.2, -34.0], 11: [7.2, 7.2, -18.4], 12: [-63.3, -34.8, 46.3], 15: [250.2, -79.4, -45.7] },
    "seabed_upper": { 20: [-2.4, 9.3, -0.6], 21: [-3.0, 0.9, -5.5], 30: [0.7, 32.8, -6.2], 60: [16.5, 43.0, -13.5], 61: [-5.2, 40.7, -19.1], 62: [-16.0, 32.8, 13.1], 63: [2.2, 27.7, -16.9], 64: [4.4, 37.9, -3.2], 70: [0.9, -0.7, 1.1], 71: [0.1, 3.9, 3.7], 80: [39.2, 6.9, -6.9], 81: [-6.6, -3.7, -4.2], 90: [15.0, 10.9, -44.1], 213: [-0.5, 11.2, -2.3], 221: [-0.6, 0.0, 3.6], 260: [-1.4, 0.0, 35.8], 280: [17.1, 15.5, 18.5], 281: [24.6, 13.6, 6.7] },
    "seabed_lower": { 20: [-7.0, -0.0, -3.8], 30: [12.2, 46.2, 9.7], 50: [4.2, 60.5, 31.9], 51: [-4.0, 39.8, -8.9], 52: [-5.8, 36.7, -2.6], 53: [4.2, 36.5, 19.2], 70: [3.0, -6.1, 0.1], 71: [2.1, 9.4, -0.1], 80: [44.1, 17.6, 0.5], 81: [-21.4, -24.0, -0.9], 90: [-2.0, -3.1, -26.9], 95: [-10.3, 6.1, 232.5], 211: [1.0, 0.0, 108.9], 214: [0.0, 6.7, 30.0], 280: [62.4, 12.5, 36.6], 290: [-35.5, 9.7, 0.1], 291: [27.6, -10.0, 0.4] },
    "crater_east": { 10: [-75.2, 0.7, -24.2], 11: [-118.9, 0.6, -41.0], 20: [88.5, 4.1, -35.1], 21: [96.1, 7.5, 4.5], 22: [113.5, 7.7, 25.4], 30: [46.6, 1.1, -124.8], 40: [41.3, 2.4, -140.1], 41: [43.7, 1.3, -155.5], 50: [-114.5, 0.9, 38.7], 60: [-87.6, 0.7, -162.3], 80: [82.6, 0.9, -51.1], 90: [-68.1, 0.1, -124.1] },
    "desert1": { 20: [-0.8, 0.1, 79.7], 30: [5.3, 2.1, -6.4], 41: [25.1, 0.1, 19.9], 50: [45.0, 0.6, 22.3], 60: [-19.0, 0.1, 5.3], 61: [-9.2, 0.1, -2.9], 62: [3.9, 0.0, -12.4], 63: [-20.0, 0.2, -8.9], 64: [-0.1, 0.2, -2.5], 70: [-24.3, 0.2, -34.3], 90: [10.2, 0.1, 6.5], 100: [116.0, -4.1, -101.2], 110: [-68.1, 0.0, 32.3] },
    "desert2": { 10: [46.4, 0.0, 57.2], 20: [2.8, 0.0, -6.2], 21: [-9.9, 0.5, -1.7], 22: [-4.3, 0.0, 15.6], 23: [-7.3, 0.1, -13.1], 24: [-21.3, 0.3, -23.0], 25: [-4.4, 0.1, -19.2], 27: [10.8, 0.0, -7.5], 40: [-1.9, -0.0, 3.6], 41: [16.4, -0.0, -18.0], 42: [-3.5, -0.0, -26.3], 50: [-20.9, -2.0, -4.8] },
    "desert3": { 20: [-60.8, 0.1, -3.0], 21: [-3.8, 0.1, 4.6], 40: [7.4, -0.0, -12.9], 41: [3.2, 0.0, 1.1], 42: [-1.0, -0.0, -5.1], 50: [-39.5, 0.0, 9.6], 51: [48.2, -1.2, 1.3], 60: [-22.1, -4.9, 59.9], 61: [7.0, -4.8, 54.3], 70: [-37.9, -0.1, 99.7], 80: [-12.6, 6.5, 17.6], 100: [6.9, 0.0, -10.1], 101: [-14.0, 0.3, -5.3], 110: [-16.4, -26.7, -13.6] },
}
...
def generate_quest_files(spec, out_dir):
    ...
    area_key = get_area_key(spec.get('wireframe_id', ''), spec.get('area_name', ''))
    sec_ids = AUTHENTIC_ROOMS.get(area_key, [2, 4, 5, 7, 8, 10, 11, 16])
    area_offsets = AUTHENTIC_ROOM_OFFSETS.get(area_key, {})
    ...
    enter_offsets = area_offsets.get(combat_rooms[0], [0.0, 0.0, 0.0])
    exit_offsets = area_offsets.get(target_clear_room, [0.0, 0.0, 0.0])
    ...
    objects_rows = [
        ...
        # Stage Infiltration Warp (local room polygon center)
        f"{spec['floor_idx']},{combat_rooms[0]},0x0019,Warp_StageIn,{enter_offsets[0]:.1f},{enter_offsets[1]:.1f},{enter_offsets[2]:.1f},0x0000,0,0,0",
        # Laser barrier fence at first combat room (+12.0 along Z from room center)
        f"{spec['floor_idx']},{combat_rooms[0]},0x0004,Laser_Fence_Barrier,{enter_offsets[0]:.1f},{enter_offsets[1]:.1f},{enter_offsets[2] + 12.0:.1f},0x0000,1,0,0",
        # Floor Terminal Switch at final room (-12.0 along X from room center)
        f"{spec['floor_idx']},{target_clear_room},0x0001,Floor_Terminal_Switch,{exit_offsets[0] - 12.0:.1f},{exit_offsets[1]:.1f},{exit_offsets[2]:.1f},0x0000,1,0,0",
        # Extraction Warp back to Pioneer 2 (+12.0 along X from room center)
        f"{spec['floor_idx']},{target_clear_room},0x0002,Warp_Extract_Pioneer2,{exit_offsets[0] + 12.0:.1f},{exit_offsets[1]:.1f},{exit_offsets[2]:.1f},0x0000,0,1,0"
    ]
    ...
    for w_idx, room_id in enumerate(combat_rooms):
        ...
        r_off = area_offsets.get(room_id, [0.0, 0.0, 0.0])
        ox, oy, oz = r_off[0], r_off[1], r_off[2]
        for i in range(e_count):
            radius = 8.0 + (i % 4) * 3.5
            angle_rad = (3.14159 * 2 * i) / e_count + (wave_num * 0.6)
            x = ox + radius * math.cos(angle_rad)
            y = oy
            z = oz + radius * math.sin(angle_rad)
