...
**[Extracted wireframe and section IDs](geometry/README.md#forest-2)** · [Geometry JSON](geometry/map_forest02.json). Numbered section positions and collision triangles are now decoded; room boundary assignment and safe spawn validation remain pending.
...
[map_forest02](geometry/map_forest02.md)
