...
def main(src):
    ...
    md += ['[NPC appearance field reference and byte checks](npc-appearance/README.md) — BB offsets, editor controls, colour/name behavior and pending save/reopen fixtures.','']
