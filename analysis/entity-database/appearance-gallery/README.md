...
Coverage: 57 previews across 62 NPC definitions. Missing previews are listed explicitly. [443 offline selector and special-model render sheets are now available](supported/README.md). All-combination and native visual verification remain incomplete.
...
The 0x0118 Quest NPC classification has been corrected in the entity index and SQLite archive.
