# TBoss3VoloptHiraisin

DAT ID **0x00C7 / 199**, constructor **TBoss3VoloptHiraisin**.

[Definition source](../../quest-knowledge/reference/server-source/Map.cc#L2956) · [Database index](../monsters.md)
...
Pillar (lightning rod)
```

## Observed quest placements

0 records, including language duplicates. These are observations, not spawn permissions.
